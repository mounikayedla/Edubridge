	 ...
	 JLabel l;  //for setting question text
	    ...
	    {  
	        try
	        {
	            ...
	            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mounika","root","mounika123"); //connecting to database 'qa'
	    ...
	    {  
	        ...
	        {
	            Class.forName("com.mysql.cj.jdbc.Driver");
	            Connection con = DriverManager.getConnection(""); //connecting to database 'qa'
	            Statement stmt = con.createStatement();
	            if(current==0)  
	            {    
	    ...
	    void adduserans() //function to connect to qa database and insert user's answers into ua table
	    {
	        ...
	        {
	            Class.forName("com.mysql.cj.jdbc.Driver");
	            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mounika","root","mounika123");
	            Statement stmt = con.createStatement();
	            for(int i=0;i<=3;i++)
	            {
